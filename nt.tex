...
\mint{haskell}{fmap f . safeHead = safeHead . fmap f}. I.e. it
does not matter if we initially apply \mint{haskell}{fmap f} and
then \mint{haskell}{safeHead} to the result or initially
\mint{haskell}{safeHead} and then \mint{haskell}{fmap f}.
...
Using the fact that \mint{haskell}{fmap f} is an expensive

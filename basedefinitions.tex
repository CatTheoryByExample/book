...
\begin{definition}[Morphism]
  ...
  \]
  is called \textit{morphism}. Morphism assumes a direction i.e. one
...
\begin{definition}[Arrow]
  \label{def:arrow}
  \mynameref{def:morphism}s are also called as \textit{Arrows}.
\end{definition}
...
\begin{definition}[Monomorphism]
  ...
  g_1 = g_2
  \]
  then $f$ is called \textit{monomorphism}. The monomorphism between
  $a$ and $b$ is denoted as $f: a \hookrightarrow b$
\end{definition}

...
\mynameref{def:pure_function} (without side effects). This requirement
...
axiom invalid (see \mynameref{rem:hask_lazy_eval}). 
...
with 3 objects that are types: \textbf{Int}, \textbf{Bool},
\textbf{String}. There are also several functions between them (see
\cref{fig:pl_example}).    

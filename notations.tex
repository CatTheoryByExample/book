...
\nomenclature{$F: \cat{C} \tof \cat{D}$}{\mynameref{def:functor}
  (double arrow)}
\nomenclature{$F \circ G$}{\mynameref{def:functor_composition} (circle dot)}
...
\nomenclature{$cone(c, f^{(c)})$}{\mynameref{def:cone}}
\nomenclature{$\Delta \downarrow F$}{\mynameref{def:category_of_cones}}

...
$\Delta_c: \cat{I} \tof \cat{C}$. By the definition of the
\mynameref{def:nt} $\Delta_c
\tont F$, it is the set of \mynameref{def:morphism}s from $\cat{C}$ with
...
\mynameref{def:index_category} $\cat{I}$. The \mynameref{def:limit}

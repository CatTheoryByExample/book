...
\mynameref{def:indexcategory} then we can get
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[ele/.style={fill=black,circle,minimum
      ...
      \node[ele,label=above:$c$] (d) at (3.5,7) {};
      \node[ele,label=below:$t$] (l) at (3.5,5) {};

      \node [draw, thick, circle, minimum width=5cm]  at (3.5,0) {};
      \node[draw,fit= (d) (l),minimum width=5cm, minimum
        height=5cm] {} ;
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[ele/.style={fill=black,circle,minimum
      ...
      \node[ele,label=above:$c$] (d) at (3.5,7) {};
      \node[ele,label=below:$i$] (l) at (3.5,5) {};
...
\mynameref{def:indexcategory} then we can get \mynameref{def:product}

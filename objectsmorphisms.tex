...
as a \mynameref{def:cartesian_product}: $C = A \times B = \{(a,b)| a \in
A, b \in B\}$. 
...
\nonumber
\end{eqnarray}
We can only one morphism $h$ that satisfied conditions
\eqref{eq:product}:
\[
...
From other side there are a lot of $h': C \to C'$:
\[

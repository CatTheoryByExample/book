...
$\cat{C}$ are equal if there exists a unique
\mynameref{def:isomorphism} $a \cong_f b$. This also means that
there exists a unique isomorphism $b \cong_g a$. These two
\mynameref{def:morphism}s ($f$ and $g$) are related to each other via
